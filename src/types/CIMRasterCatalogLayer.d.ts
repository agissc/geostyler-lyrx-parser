...
export type CIMRasterCatalogLayer = CIMGeoFeatureLayerBase & {
  /**
   * Gets or sets threshold for displaying wire frames.
   */
  displayRastersThreshold?: number;
  /**
   * Gets or sets a value indicating whether or not to draw only rasters.
   */
  drawRastersOnly?: boolean;
  /**
   * Gets or sets a value indicating whether or not to draw labels in fixed positions relative to the tile boundaries, and does not use the label placement engine.
   */
  fixedLabelPositions?: boolean;
  /**
   * Gets or sets the colorizer mapping.
   */
  colorizerMapping?: CIMRasterColorizerMapping[] | null;
  /**
   * Gets or sets the colorizer.
   */
  colorizers?: CIMRasterColorizer[] | null;
  /**
   * Gets or sets the resampling type.
   */
  resamplingType?: RasterResamplingType;
  /**
   * Gets or sets the transition scale.
   */
  transitionScale?: number;
  /**
   * Gets or sets a value indicating whether or not to use color correction.
   */
  useColorCorrection?: boolean;
  /**
   * Gets or sets a value indicating whether or not to use scale.
   */
  useScale?: boolean;
  /**
   * Gets or sets the wire frame symbol.
   */
  wireFrameSymbol?: null | CIMSymbolReference;
  /**
   * Gets or sets a value indicating whether or not the sort is ascending.
   */
   ...
   */
  colorCorrection?: null | CIMRasterColorCorrection;
};
export type CIMGeoFeatureLayerBase = CIMBasicFeatureLayer & {
  /**
...
export type CIMBasicFeatureLayer = CIMBaseLayer & {
  /**
...
export type CIMEditingTemplate = CIMObject & {
  /**
   * Gets or sets the description.
   */
  description?: null | string;
...
export type CIMDisplayFilter = CIMObject & {
  /**
...
export type CIMLayerAction = CIMObject & {
  /**
   * Gets or sets the name.
   */
  name?: null | string;
...
export type CIMSymbolLayerMasking = CIMObject & {
  /**
...
export type CIMRasterColorizerMapping = CIMObject & {
  /**
