...
export type CIMMapImageLayer = CIMDynamicServiceLayer & {};
export type CIMDynamicServiceLayer = CIMServiceLayer & {
  /**
   * Gets or sets the image format.
   */
  imageFormat?: EsriImageFormat;
  /**
   * Gets or sets a value indicating whether or not to use time.
   */
  useTime?: boolean;
};
