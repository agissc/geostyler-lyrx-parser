...
export type CIMNetworkDatasetLayer = CIMBaseLayer & {
  /**
   * Gets or sets data connection to the network dataset.
   */
  dataConnection?: null | CIMDataConnection;
  /**
   * Gets or sets the dirty area renderer.
   */
  dirtyAreaRenderer?: null | CIMNetworkDatasetSimpleRenderer;
  /**
   * Gets or sets the display network attribute.
   */
  displayNetworkAttribute?: null | string;
  /**
   * Gets or sets the edge renderer.
   */
  edgeRenderer?: null | CIMNetworkDatasetSimpleRenderer;
  /**
   * Gets or sets the junction renderer.
   */
  junctionRenderer?: null | CIMNetworkDatasetSimpleRenderer;
  /**
   * Gets or sets the missing element renderer.
   */
  missingElementRenderer?: null | CIMNetworkDatasetElementCompositeRenderer;
  /**
   * Gets or sets the network source display filters.
   */
  networkSourceDisplayFilters?: CIMNetworkSourceDisplayFilter[] | null;
  /**
   * Gets or sets the one-way renderer.
   */
  oneWayRenderer?: null | CIMNetworkDatasetElementCompositeRenderer;
  /**
   * Gets or sets the restriction network attributes.
   */
  restrictionNetworkAttributes?: string[] | null;
  /**
   * Gets or sets the restriction renderer.
   */
  restrictionRenderer?: null | CIMNetworkDatasetElementCompositeRenderer;
  /**
   * Gets or sets the system junction renderer.
   */
  systemJunctionRenderer?: null | CIMNetworkDatasetSimpleRenderer;
  /**
   * Gets or sets the traffic network attribute.
   */
  trafficNetworkAttribute?: null | string;
  /**
   * Gets or sets the traffic renderer.
   */
  trafficRenderer?: null | CIMNetworkDatasetTrafficRenderer;
  /**
   * Gets or sets the traversable renderer.
   */
  traversableRenderer?: null | CIMNetworkDatasetElementCompositeRenderer;
  /**
   * Gets or sets the turn renderer.
   */
  turnRenderer?: null | CIMNetworkDatasetSimpleRenderer;
  /**
   * Gets or sets the travel mode context.
   */
  travelModeContext?: null | CIMNetworkTravelModeDefinitionContext;
  /**
   * Gets or sets the restriction status renderers.
   */
  restrictionStatusRenderers?: CIMRestrictionStatusRenderer[] | null;
  /**
   * Gets or sets a value indicating whether to classify restrictions by preference level.
   */
  classifyRestrictionsByPreferenceLevel?: boolean;
};
...
export type CIMNetworkSourceDisplayFilter = CIMObject & {
  /**
...
export type CIMNetworkDatasetTrafficRenderer = CIMNetworkDatasetRenderer & {
  /**
...
export type CIMClassBreak = CIMObject & {
  /**
...
export type CIMRestrictionStatusRenderer = CIMNetworkDatasetRenderer & {
  /**
   * Gets or sets the renderer target.
   */
  rendererTarget?: NDSRendererTarget;
  /**
   * Gets or sets the restriction status symbol classes.
   ...
   * MixedPreferenceLevelTraversable only applicable to NDSRendererTarget.Edges.
   */
  restrictionStatusSymbolClasses?: CIMRestrictionStatusSymbolClass[] | null;
  /**
   * Gets or sets the traversable directions adorner point symbol classes.
...
export type CIMTraversableDirectionsAdornerPointSymbolClass = CIMObject & {
   ...
   */
  traversableDirections?: TraversableDirections;
  /**
   * Gets or sets the label.
   */
  label?: null | string;
