...
export type CIMDiagramLayer = CIMGroupLayer & {
  /**
   * Gets or sets the digram layer's reference scale.
   */
  referenceScale?: number;
  /**
   * Gets or sets the data connection to the network diagram.
   */
  dataConnection?: null | CIMNetworkDiagramDataConnection;
};
export type CIMGroupLayer = CIMBaseLayer & {
  /**
