...
export type CIMCatalogLayer = CIMBasicFeatureLayer & {
  /**
   * Gets or sets the path of the footprint feature layer.
   */
  footprintLayer?: null | string;
  /**
   * Gets or sets threshold scale to switch to footprint layer.
   */
  thresholdScale?: number;
  /**
   * Gets or sets upper bound for number of layers in view.
   */
  maximumVisibleSublayers?: number;
};
