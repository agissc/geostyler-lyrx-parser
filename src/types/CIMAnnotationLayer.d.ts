...
export type CIMAnnotationLayer = CIMBasicFeatureLayer & {
  /**
   * Gets or sets the weight of features in this layer when considered as barriers to labeling.
   */
  ...
  /**
   * Gets or sets a value indicating whether unplaced annotation should be drawn.
   */
   ...
   */
  drawGeometryLineSymbol?: null | CIMSymbolReference;
  /**
   * Gets or sets the point symbol used to draw text graphic line geometries when the DrawGeometry option is true.
   */
  drawGeometryPointSymbol?: null | CIMSymbolReference;
  /**
   * Gets or sets the color that unplaced text graphics will be drawn with when Unplaced Annotation is drawn.
   */
  unplacedAnnotationColor?: null | CIMColor;
  /**
   * Gets or sets the type of symbol substitution this layer uses.
   */
   ...
   */
  massColorSubstitute?: null | CIMColor;
  /**
   ...
   */
  inlineColor?: null | CIMColor;
  /**
   * Gets or sets a symbol substitution collection.
   */
  substitutionSymbolCollection?: CIMSymbolIdentifier[] | null;
  /**
   ...
   */
  subLayers?: CIMAnnotationSubLayer[] | null;
};
 ...
 * Barrier weights.
 */
export type BarrierWeight = 0 | 1 | 2 | 3;
/**
 * Symbol substitution types.
 *
 */
export type SymbolSubstitutionType = 0 | 1 | 2 | 3;
export type CIMSymbolIdentifier = CIMObject & {
  /**
...
export type CIMAnnotationSubLayer = CIMSubLayerBase & {};
