...
export type CIMPointCloudLayer = CIMBaseLayer & {
  /**
   * Gets or sets the symbol renderer.
   */
  renderer?: null | CIMPointCloudRenderer;
  /**
   * Gets or sets the data connection.
   */
  dataConnection?: null | CIMSceneDataConnection;
  /**
   * Gets or sets the double value that determines the number of points to draw per display inch.
   */
   ...
   */
  filters?: CIMPointCloudFilter[] | null;
  /**
...
export type CIMPointCloudFilter = CIMObject & {
  /**
